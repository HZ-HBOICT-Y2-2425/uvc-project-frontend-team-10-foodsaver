<script>
    ...
    let username: string | null = null;  // Hacemos explícito que puede ser string o null
...
<div class="w-full h-full bg-white p-8 font-[Kalam]">
    ...
    <div class="text-center mb-8">
        <!-- Usamos username de forma condicional si no es null -->
        <h1 class="text-green-900 text-5xl font-bold">
